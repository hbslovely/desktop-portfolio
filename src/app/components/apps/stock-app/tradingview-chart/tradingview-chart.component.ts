...
@Component({
  ...
  template: `
    <div class="tv-chart-wrapper" [class.fullscreen]="isFullscreen()" #chartWrapper>
      <div class="chart-toolbar">
        ...
        <div class="chart-actions">
          ...
          <button
            ...
            title="Hiển thị khối lượng"
          >
            <i class="pi pi-chart-bar"></i> Vol
          </button>
          <button
            (click)="toggleIndicatorPanel()"
            [class.active]="showIndicatorPanel()"
        ...
        <div class="indicator-panel-body">
          ...
          <div class="indicator-group">
            ...
            <div class="indicator-settings" *ngIf="indicators().ma.enabled">
              ...
              <div class="setting-row">
                ...
                <input
                  type="color"
                  [value]="indicators().ma.color"
                  (input)="updateIndicator('ma', 'color', $any($event.target).value)"
                />
              </div>
              <div class="period-presets">
                <button
                  (click)="updateIndicator('ma', 'period', 10)"
                  [class.active]="indicators().ma.period === 10"
                >
                  MA10
                </button>
                <button
                  (click)="updateIndicator('ma', 'period', 20)"
                  [class.active]="indicators().ma.period === 20"
                >
                  MA20
                </button>
                <button
                  (click)="updateIndicator('ma', 'period', 50)"
                  [class.active]="indicators().ma.period === 50"
                >
                  MA50
                </button>
                <button
                  (click)="updateIndicator('ma', 'period', 100)"
                  [class.active]="indicators().ma.period === 100"
                >
                  MA100
                </button>
                <button
                  (click)="updateIndicator('ma', 'period', 200)"
                  [class.active]="indicators().ma.period === 200"
                >
                  MA200
                </button>
              </div>
          ...
          <div class="indicator-group">
            ...
            <div class="indicator-settings" *ngIf="indicators().ema.enabled">
              ...
              <div class="period-presets">
                <button
                  (click)="updateIndicator('ema', 'period', 12)"
                  [class.active]="indicators().ema.period === 12"
                >
                  EMA12
                </button>
                <button
                  (click)="updateIndicator('ema', 'period', 26)"
                  [class.active]="indicators().ema.period === 26"
                >
                  EMA26
                </button>
                <button
                  (click)="updateIndicator('ema', 'period', 50)"
                  [class.active]="indicators().ema.period === 50"
                >
                  EMA50
                </button>
                <button
                  (click)="updateIndicator('ema', 'period', 200)"
                  [class.active]="indicators().ema.period === 200"
                >
                  EMA200
                </button>
              </div>
          ...
          <div class="indicator-group">
            <div class="indicator-header">
              <label class="indicator-toggle">
                <input
                  type="checkbox"
                  [checked]="indicators().sma2.enabled"
          ...
          <div class="indicator-group theme-group">
            ...
            <div class="indicator-settings">
              <div class="theme-presets">
                <button
                  class="theme-btn"
                  [class.active]="chartTheme().preset === 'dark'"
                ...
                <button
                  class="theme-btn"
                  [class.active]="chartTheme().preset === 'light'"
                ...
                <button
                  class="theme-btn"
                  [class.active]="chartTheme().preset === 'tradingview'"
                ...
                <button
                  class="theme-btn"
                  [class.active]="chartTheme().preset === 'custom'"
          ...
          <div class="indicator-group">
            ...
            <div class="indicator-settings">
              <div class="candle-style-presets">
                <button
                  class="style-btn"
                  [class.active]="candleStyle() === 'filled'"
                ...
                <button
                  class="style-btn"
                  [class.active]="candleStyle() === 'hollow'"
      ...
      <div class="chart-tooltip" *ngIf="tooltipData()">
        <div class="tooltip-header">
          ...
          <span
            ...
            [class.positive]="tooltipData()!.change >= 0"
            [class.negative]="tooltipData()!.change < 0"
          >
            {{ tooltipData()!.change >= 0 ? '+' : ''
            }}{{ tooltipData()!.change | number: '1.0-0' }}đ ({{
      ...
      <div
        ...
        *ngIf="markerTooltipData()"
        [class.buy]="markerTooltipData()!.type === 'buy'"
        [class.sell]="markerTooltipData()!.type === 'sell'"
        [class.profit]="
          markerTooltipData()!.profitLoss !== undefined && markerTooltipData()!.profitLoss! >= 0
        "
        [class.loss]="
          markerTooltipData()!.profitLoss !== undefined && markerTooltipData()!.profitLoss! < 0
        "
      >
        <div class="marker-tooltip-header">
          <span class="marker-type">{{
            markerTooltipData()!.type === 'buy' ? '▲ MUA' : '▼ BÁN'
          }}</span>
        ...
        <div class="marker-tooltip-body">
          <div class="tooltip-row">
            <span class="label"
              >Giá {{ markerTooltipData()!.type === 'buy' ? 'mua' : 'bán' }}:</span
            >
            <span class="value">{{ markerTooltipData()!.price | number: '1.0-0' }}đ</span>
          </div>
          <div
            class="tooltip-row"
            *ngIf="markerTooltipData()!.originalBuyPrice && markerTooltipData()!.type === 'sell'"
          >
            <span class="label">Giá mua gốc:</span>
            <span class="value muted"
              >{{ markerTooltipData()!.originalBuyPrice | number: '1.0-0' }}đ</span
            >
          </div>
          <div class="tooltip-row">
          ...
          <div
            class="tooltip-row profit-row"
            *ngIf="
              markerTooltipData()!.profitLoss !== undefined && markerTooltipData()!.type === 'sell'
            "
          >
            <span class="label">{{
              markerTooltipData()!.profitLoss! >= 0 ? '💰 Lãi:' : '📉 Lỗ:'
            }}</span>
            <span
              class="value profit-value"
              [class.positive]="markerTooltipData()!.profitLoss! >= 0"
              [class.negative]="markerTooltipData()!.profitLoss! < 0"
            >
              {{ markerTooltipData()!.profitLoss! >= 0 ? '+' : ''
              }}{{ markerTooltipData()!.profitLoss! | number: '1.0-0' }}đ
              <span class="percent" *ngIf="markerTooltipData()!.profitLossPercent !== undefined">
                ({{ markerTooltipData()!.profitLossPercent! >= 0 ? '+' : ''
                }}{{ markerTooltipData()!.profitLossPercent!.toFixed(2) }}%)
              </span>
            </span>
          </div>
        </div>
  ...
  styles: [
    `
      ...
      .tooltip-row .value.ceiling {
        color: #ce93d8;
      }
      .tooltip-row .value.floor {
        color: #4fc3f7;
      }
...
export class TradingviewChartComponent implements OnInit, OnDestroy, OnChanges {
  ...
  private updateMarkerTooltip(hoverTime: number) {
    ...
    if (marker) {
      ...
      if (marker.type === 'sell' && marker.originalBuyPrice && !profitLoss) {
        ...
        profitLossPercent =
          ((marker.price - marker.originalBuyPrice) / marker.originalBuyPrice) * 100;
      }
  ...
  private clearIndicatorSeries() {
    if (this.chart) {
      ...
      if (this.sma2Series) {
        this.chart.removeSeries(this.sma2Series);
        this.sma2Series = null;
      }
