...
export class NewsAppComponent implements OnInit, OnDestroy {
  ...
  viewModes = [
    {
      id: 'list' as const,
      name: 'List View - Compact Flattened',
      icon: 'pi pi-list',
      tooltip: 'Compact horizontal list',
    },
    {
      id: 'grid' as const,
      name: 'Grid View - Image Overlay',
      icon: 'pi pi-th-large',
      tooltip: 'Grid with image background',
    },
    {
      id: 'compact' as const,
      name: 'Large View - Detailed',
      icon: 'pi pi-bars',
      tooltip: 'Large cards with more details',
    },
  ];
