...
function getAppDescription(appId: string): string {
  const descriptions: { [key: string]: string } = {
    ...
    'angular-guidelines':
      'Comprehensive Angular official documentation and guidelines from Angular.dev',
    'tuoitre-news':
      'Read latest Vietnamese news from Tuổi Trẻ Online with categories and full articles',
    expense:
    ...
    stock:
      'Quản lý và fetch dữ liệu cổ phiếu từ DNSE, lưu vào Google Sheets. Hỗ trợ HOSE, HNX, UPCOM, VN30',
    'sieu-co':
    ...
    'shop-clone':
      'Bản clone UI homepage Shopee với tìm kiếm, danh mục, flash sale, Shopee Mall, sản phẩm và giỏ hàng',
  };
