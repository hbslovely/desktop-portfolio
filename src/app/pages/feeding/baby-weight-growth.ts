...
export function approxSdKgAtWeeks(weeks: number, sex: WeightGrowthSex): number {
  if (sex === 'female') {
    const months = (Math.max(0, weeks) * 7) / 30.4375;
    const min = interpolateGirlReferenceByMonths(
      months,
      (row) => row.weightMinus2SdKg
    );
    const max = interpolateGirlReferenceByMonths(
      months,
      (row) => row.weightPlus2SdKg
    );
...
const BOY_LENGTH_MEDIAN_CM_BY_MONTH: readonly number[] = [
  ...
  76.9, 78.0, 79.2, 80.3, 81.3, 82.3, 83.3, 84.2, 85.1, 86.0, 86.9, 87.8,
];
...
const GIRL_WHO_RANGE_REFERENCE_TABLE: readonly WhoGirlRangeReferenceRow[] = [
  { monthsAge: 0, ageLabelVi: 'Sơ sinh', weightMinus2SdKg: 2.4, weightMedianKg: 3.2, weightPlus2SdKg: 4.2, heightMinus2SdCm: 45.4, heightMedianCm: 49.1, heightPlus2SdCm: 52.9 },
  { monthsAge: 1, ageLabelVi: '1 tháng', weightMinus2SdKg: 3.2, weightMedianKg: 4.2, weightPlus2SdKg: 5.5, heightMinus2SdCm: 49.8, heightMedianCm: 53.7, heightPlus2SdCm: 57.6 },
  { monthsAge: 2, ageLabelVi: '2 tháng', weightMinus2SdKg: 3.9, weightMedianKg: 5.1, weightPlus2SdKg: 6.6, heightMinus2SdCm: 53.0, heightMedianCm: 57.1, heightPlus2SdCm: 61.1 },
  { monthsAge: 3, ageLabelVi: '3 tháng', weightMinus2SdKg: 4.5, weightMedianKg: 5.8, weightPlus2SdKg: 7.5, heightMinus2SdCm: 55.6, heightMedianCm: 59.8, heightPlus2SdCm: 64.0 },
  { monthsAge: 4, ageLabelVi: '4 tháng', weightMinus2SdKg: 5.0, weightMedianKg: 6.4, weightPlus2SdKg: 8.2, heightMinus2SdCm: 57.8, heightMedianCm: 62.1, heightPlus2SdCm: 66.4 },
  { monthsAge: 5, ageLabelVi: '5 tháng', weightMinus2SdKg: 5.4, weightMedianKg: 6.9, weightPlus2SdKg: 8.8, heightMinus2SdCm: 59.6, heightMedianCm: 64.0, heightPlus2SdCm: 68.5 },
  { monthsAge: 6, ageLabelVi: '6 tháng', weightMinus2SdKg: 5.7, weightMedianKg: 7.3, weightPlus2SdKg: 9.3, heightMinus2SdCm: 61.2, heightMedianCm: 65.7, heightPlus2SdCm: 70.3 },
  { monthsAge: 7, ageLabelVi: '7 tháng', weightMinus2SdKg: 6.0, weightMedianKg: 7.6, weightPlus2SdKg: 9.8, heightMinus2SdCm: 62.7, heightMedianCm: 67.3, heightPlus2SdCm: 71.9 },
  { monthsAge: 8, ageLabelVi: '8 tháng', weightMinus2SdKg: 6.3, weightMedianKg: 7.9, weightPlus2SdKg: 10.2, heightMinus2SdCm: 64.0, heightMedianCm: 68.7, heightPlus2SdCm: 73.5 },
  { monthsAge: 9, ageLabelVi: '9 tháng', weightMinus2SdKg: 6.5, weightMedianKg: 8.2, weightPlus2SdKg: 10.5, heightMinus2SdCm: 65.3, heightMedianCm: 70.1, heightPlus2SdCm: 75.0 },
  { monthsAge: 10, ageLabelVi: '10 tháng', weightMinus2SdKg: 6.7, weightMedianKg: 8.5, weightPlus2SdKg: 10.9, heightMinus2SdCm: 66.5, heightMedianCm: 71.5, heightPlus2SdCm: 76.4 },
  { monthsAge: 11, ageLabelVi: '11 tháng', weightMinus2SdKg: 6.9, weightMedianKg: 8.7, weightPlus2SdKg: 11.2, heightMinus2SdCm: 67.7, heightMedianCm: 72.8, heightPlus2SdCm: 77.8 },
  { monthsAge: 12, ageLabelVi: '12 tháng', weightMinus2SdKg: 7.0, weightMedianKg: 8.9, weightPlus2SdKg: 11.5, heightMinus2SdCm: 68.9, heightMedianCm: 74.0, heightPlus2SdCm: 79.2 },
  { monthsAge: 15, ageLabelVi: '15 tháng', weightMinus2SdKg: 7.6, weightMedianKg: 9.6, weightPlus2SdKg: 12.4, heightMinus2SdCm: 72.0, heightMedianCm: 77.5, heightPlus2SdCm: 83.0 },
  { monthsAge: 18, ageLabelVi: '18 tháng', weightMinus2SdKg: 8.1, weightMedianKg: 10.2, weightPlus2SdKg: 13.2, heightMinus2SdCm: 74.9, heightMedianCm: 80.7, heightPlus2SdCm: 86.5 },
  { monthsAge: 21, ageLabelVi: '21 tháng', weightMinus2SdKg: 8.6, weightMedianKg: 10.9, weightPlus2SdKg: 14.0, heightMinus2SdCm: 77.5, heightMedianCm: 83.7, heightPlus2SdCm: 89.8 },
  { monthsAge: 24, ageLabelVi: '24 tháng', weightMinus2SdKg: 9.0, weightMedianKg: 11.5, weightPlus2SdKg: 14.8, heightMinus2SdCm: 80.0, heightMedianCm: 86.4, heightPlus2SdCm: 92.9 },
  { monthsAge: 30, ageLabelVi: '2.5 tuổi', weightMinus2SdKg: 10.0, weightMedianKg: 12.7, weightPlus2SdKg: 16.5, heightMinus2SdCm: 83.6, heightMedianCm: 90.7, heightPlus2SdCm: 97.7 },
  { monthsAge: 36, ageLabelVi: '3 tuổi', weightMinus2SdKg: 10.8, weightMedianKg: 13.9, weightPlus2SdKg: 18.1, heightMinus2SdCm: 87.4, heightMedianCm: 95.1, heightPlus2SdCm: 102.7 },
  { monthsAge: 42, ageLabelVi: '3.5 tuổi', weightMinus2SdKg: 11.6, weightMedianKg: 15.0, weightPlus2SdKg: 19.8, heightMinus2SdCm: 90.9, heightMedianCm: 99.0, heightPlus2SdCm: 107.2 },
  { monthsAge: 48, ageLabelVi: '4 tuổi', weightMinus2SdKg: 12.3, weightMedianKg: 16.1, weightPlus2SdKg: 21.5, heightMinus2SdCm: 94.1, heightMedianCm: 102.7, heightPlus2SdCm: 111.3 },
  { monthsAge: 54, ageLabelVi: '4.5 tuổi', weightMinus2SdKg: 13.0, weightMedianKg: 17.2, weightPlus2SdKg: 23.2, heightMinus2SdCm: 97.1, heightMedianCm: 106.2, heightPlus2SdCm: 115.2 },
  { monthsAge: 60, ageLabelVi: '5 tuổi', weightMinus2SdKg: 13.7, weightMedianKg: 18.2, weightPlus2SdKg: 24.9, heightMinus2SdCm: 99.9, heightMedianCm: 109.4, heightPlus2SdCm: 118.9 },
  { monthsAge: 66, ageLabelVi: '5.5 tuổi', weightMinus2SdKg: 14.6, weightMedianKg: 19.1, weightPlus2SdKg: 26.2, heightMinus2SdCm: 102.3, heightMedianCm: 112.2, heightPlus2SdCm: 122.0 },
  { monthsAge: 72, ageLabelVi: '6 tuổi', weightMinus2SdKg: 15.3, weightMedianKg: 20.2, weightPlus2SdKg: 27.8, heightMinus2SdCm: 104.9, heightMedianCm: 115.1, heightPlus2SdCm: 125.4 },
  { monthsAge: 78, ageLabelVi: '6.5 tuổi', weightMinus2SdKg: 16.0, weightMedianKg: 21.2, weightPlus2SdKg: 29.6, heightMinus2SdCm: 107.4, heightMedianCm: 118.0, heightPlus2SdCm: 128.6 },
  { monthsAge: 84, ageLabelVi: '7 tuổi', weightMinus2SdKg: 16.8, weightMedianKg: 22.4, weightPlus2SdKg: 31.4, heightMinus2SdCm: 109.9, heightMedianCm: 120.8, heightPlus2SdCm: 131.7 },
  { monthsAge: 90, ageLabelVi: '7.5 tuổi', weightMinus2SdKg: 17.6, weightMedianKg: 23.6, weightPlus2SdKg: 33.5, heightMinus2SdCm: 112.4, heightMedianCm: 123.7, heightPlus2SdCm: 134.9 },
  { monthsAge: 96, ageLabelVi: '8 tuổi', weightMinus2SdKg: 18.6, weightMedianKg: 25.0, weightPlus2SdKg: 35.8, heightMinus2SdCm: 115.0, heightMedianCm: 126.6, heightPlus2SdCm: 138.2 },
  { monthsAge: 102, ageLabelVi: '8.5 tuổi', weightMinus2SdKg: 19.6, weightMedianKg: 26.6, weightPlus2SdKg: 38.3, heightMinus2SdCm: 117.6, heightMedianCm: 129.5, heightPlus2SdCm: 141.4 },
  { monthsAge: 108, ageLabelVi: '9 tuổi', weightMinus2SdKg: 20.8, weightMedianKg: 28.2, weightPlus2SdKg: 41.1, heightMinus2SdCm: 120.3, heightMedianCm: 132.5, heightPlus2SdCm: 144.7 },
  { monthsAge: 114, ageLabelVi: '9.5 tuổi', weightMinus2SdKg: 20.0, weightMedianKg: 30.0, weightPlus2SdKg: 43.8, heightMinus2SdCm: 123.0, heightMedianCm: 135.5, heightPlus2SdCm: 148.1 },
  { monthsAge: 120, ageLabelVi: '10 tuổi', weightMinus2SdKg: 23.3, weightMedianKg: 31.9, weightPlus2SdKg: 46.9, heightMinus2SdCm: 125.8, heightMedianCm: 138.6, heightPlus2SdCm: 151.4 },
];
...
function heightMedianTableForSex(sex: WeightGrowthSex): readonly number[] {
  return sex === 'male'
    ? BOY_LENGTH_MEDIAN_CM_BY_MONTH
    : GIRL_LENGTH_MEDIAN_CM_BY_MONTH;
}
...
export function medianHeightCmAtMonths(
  months: number,
  sex: WeightGrowthSex
): number {
  if (sex === 'female') {
    return interpolateGirlReferenceByMonths(
      Math.max(0, months),
      (row) => row.heightMedianCm
    );
  }
  return interpolateSeries(months, heightMedianTableForSex(sex));
}

export function approxSdHeightCmAtMonths(
  months: number,
  sex: WeightGrowthSex
): number {
  if (sex === 'female') {
    ...
    const min = interpolateGirlReferenceByMonths(
      m,
      (row) => row.heightMinus2SdCm
    );
    const max = interpolateGirlReferenceByMonths(
      m,
      (row) => row.heightPlus2SdCm
    );
...
export function evaluateHeightForAge(
  ...
  return {
    ...
    monthsLabel:
      roundedMonths < 1
        ? `${Math.max(1, Math.floor(days))} ngày`
        : `${roundedMonths} tháng`,
